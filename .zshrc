...
# Path
export PATH=~/go/bin:/usr/local/sbin/jadx-1.4.4/bin:/usr/local/sbin/ghidra_10.1.5_PUBLIC:/usr/bin/java:~/.local/bin:$PATH
...
bash ~/.scripts/shell-color-scripts/colorscript.sh -r
alias dell='rm -rf * && rm -rf .*'
alias hackingclub="cd && sudo openvpn vpn.ovpn"
