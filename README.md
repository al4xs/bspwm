|![bspwm-environment](https://github.com/Al4xs/bspwm/blob/main/resources/bspwm.png?raw=true)|
|---|
...
- **Color Scheme:** [theaming](https://github.com/Al4xs/bspwm/blob/main/scripts/Theaming.sh)
- **Default Theme:** [xavier](https://github.com/Al4xs/bspwm/tree/main#xavier)
...
1. [**Zenitsu**](https://github.com/Al4xs/bspwm/tree/main#zenitsu)
2. [**Raven**](https://github.com/Al4xs/bspwm/tree/main#raven)
3. [**Simon**](https://github.com/Al4xs/bspwm/tree/main#simon)
4. [**Camila**](https://github.com/Al4xs/bspwm/tree/main#camila)
5. [**Ryan**](https://github.com/Al4xs/bspwm/tree/main#ryan)
6. [**Esmeralda**](https://github.com/Al4xs/bspwm/tree/main#esmeralda)
7. [**Xavier**](https://github.com/Al4xs/bspwm/tree/main#xavier)
8. [**Nami**](https://github.com/Al4xs/bspwm/tree/main#nami)
...
- 🎨 Switch themes and modes [**theaming**](https://github.com/Al4xs/bspwm/blob/main/scripts/Theaming.sh)
- 📡 Connect to wifi using nmcli utility [**wifi**](https://github.com/Al4xs/bspwm/blob/main/scripts/wifi.sh)
- 🖥️ Resize the kitty window to the indicated position [**rezise**](https://github.com/Al4xs/bspwm/blob/main/scripts/rezise.sh)
- 📦 Update the system in an easy and simple way [**updates**](https://github.com/Al4xs/bspwm/blob/main/scripts/updates.sh)

## Keyboard shortcuts

All keyboard shortcuts in [**sxhkdrc**](https://github.com/Al4xs/bspwm/blob/main/.config/sxhkd/sxhkdrc) file.
...
```bash
git clone https://github.com/Al4xs/bspwm.git ; cd bspwm
```
